...
const OrderSummary = () => {
  ...
  const { currency, router, getCartCount, getCartAmount, userData, cartItems, setPopOverOpen } = useAppContext()
  ...
  return (
    <div className="w-full md:w-96 bg-gray-500/5 p-5">
      ...
      <button onClick={handleCheckout} className="w-full bg-orange-600 text-white py-3 mt-5 hover:bg-orange-700">
        Place Order
      </button>
    </div>
  );
