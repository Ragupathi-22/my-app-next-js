        ...
        <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                ...
                <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-0.5">
                            {Array.from({ length: 5 }).map((_, index) => (
                                <Image
                                    ...
                                    className="h-3 w-3"
                                    src={
                                        index < Math.floor(Math.round(productData.average_rating))
                                            ? assets.star_icon
                    ...
                    <p className="text-gray-600 mt-3" dangerouslySetInnerHTML={{ __html: productData.description }}>
                    </p>
                        ...
                        <table className="table-auto border-collapse w-full max-w-72">
                            <tbody>
                                ...
                                {productData?.attributes?.map((attribute, index) => (
                                    <tr key={index}>
                                        <td className="text-gray-600 font-medium">{attribute.name}</td>
                                        <td className="text-gray-800/50">
